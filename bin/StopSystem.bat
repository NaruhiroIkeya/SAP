:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: Program	: StopSystem.bat
:: Title	: SAP System Shutdown
::
:: Argument	: 1. SAP SystemID
:: ReturnCode	: 0=Success, 1=Error
:: Purpose	: Execute SAP System Shutdown.
::
:: Version	: v01
...
SET __LOGFILE__=%__LOGPATH__%\%__SID__%_SAP_STOP_%__NOW__%.log
FORFILES /P %__LOGPATH__% /M %__SID__%_SAP_STOP_*.log /D -180 /C "CMD /C IF @isdir==FALSE DEL /Q @path" > NUL 2>&1
...
SET __XMLFILE__=%__XMLPATH__%\StopSAPSystemConfig_%__SID__%.xml
...
::       Call  PowerShell       ::
:::::::::::::::::::::::::::::::
CALL :__ECHO__ %__SID__% Instance Stop.
powershell -inputformat none -NoProfile -command "%~dp0StopInstance.ps1 %__SID__% %__XMLFILE__%;exit $LASTEXITCODE" >>"%__LOGFILE__%"
IF ERRORLEVEL 1 (
  CALL :__ECHO__ %__SID__% Instance Stop Error.
  EXIT /B 1
)
CALL :__ECHO__ %__SID__% Instance Stop Success.
